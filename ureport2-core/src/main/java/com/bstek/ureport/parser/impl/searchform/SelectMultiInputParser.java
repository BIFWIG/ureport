...
import com.bstek.ureport.definition.searchform.SelectMultiInputComponent;
 ...
 * @since 2017年10月30日
 */
public class SelectMultiInputParser implements FormParser<SelectMultiInputComponent> {
	@Override
	public SelectMultiInputComponent parse(Element element) {
		SelectMultiInputComponent select=new SelectMultiInputComponent();
	...
	public boolean support(String name) {
		return name.equals("input-multiSelect");
	}
}
