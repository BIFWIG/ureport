 ...
 * @since 2017年10月23日
 */
public class SelectMultiInputComponent extends InputComponent {
	...
	String inputHtml(RenderContext context) {
		...
		sb.append("<select multiple=\"multiple\" style=\"padding:3px;height:28px\" id='"+context.buildComponentId(this)+"' name='"+name+"' class='selectpicker form-control'>");
